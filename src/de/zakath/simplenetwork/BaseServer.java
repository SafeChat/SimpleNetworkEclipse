...
public class BaseServer
{
	...
	public boolean listen(boolean async)
	{
					...
					while (true)
					{
						try
						{
							...
							bc.addNewMessageListener(new NewMessageListener()
							{
								...
								@Override
								public void OnNewMessage(Object sender,
						...
						{
							Logger.getLogger(BaseServer.class.getName()).log(
		...
		{
			Logger.getLogger(BaseServer.class.getName()).log(Level.SEVERE,
					null, ex);
			return false;
		}
	...
	{
		raiseConnectionLost(new ConnectiontoClientLostEventArgs(
				(BaseClient) sender));
	...
	public void addConnectiontoClientLostListener(
			ConnectiontoClientLostListener listener)
	{
