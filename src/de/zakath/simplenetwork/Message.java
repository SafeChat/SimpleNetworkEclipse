...
public class Message implements Serializable
{
	...
	{
		return _headerfields.containsKey(name.toLowerCase()) ? _headerfields
	...
	public enum MessageType implements Serializable
	{
		...
		Quit, Authinit, Auth, Authack, Message, GroupMessage, KeyRequest, KeyResponse, MessagePoll, NewAccountRequest, NewAccountResponse, Error;
	}
}
